    ...
    describe('mongoose Model functions', function () {
      ...
      describe('chaining', function () {
        it('can be made', function () {
          expect(Model.findOne({})).to.be.an.instanceof(Function);
          expect(Model.findOne({})).to.have.a.ownProperty('select');
        });
        it('result can be exec', function () {
          expect(Model.findOne({}).select({}).exec).to.be.a('function');
        });
      });
